...
import chalk.learn.perceptron.PerceptronTrainer;
...
public class TrainUtil {
  ...
  public static AbstractModel train(EventStream events, Map<String, String> trainParams, Map<String, String> reportMap) 
    ...
    if (MAXENT_VALUE.equals(algorithmName)) {
      ...
      model = chalk.learn.maxent.GIS.trainModel(iterations, indexer,
      ...
      chalk.learn.perceptron.PerceptronTrainer perceptronTrainer = new chalk.learn.perceptron.PerceptronTrainer();
