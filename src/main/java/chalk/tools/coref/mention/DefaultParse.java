...
/**
 * This class is a wrapper for {@link chalk.tools.parser.Parse} mapping it to the API specified in {@link chalk.tools.coref.mention.Parse}.
...
public class DefaultParse extends AbstractParse {
  ...
  public List<chalk.tools.coref.mention.Parse> getNamedEntities() {
  ...
  public List<chalk.tools.coref.mention.Parse> getChildren() {
    return createParses(parse.getChildren());
  }

  public List<chalk.tools.coref.mention.Parse> getSyntacticChildren() {
  ...
  public List<chalk.tools.coref.mention.Parse> getTokens() {
  ...
  private List<chalk.tools.coref.mention.Parse> createParses(Parse[] parses) {
    List<chalk.tools.coref.mention.Parse> newParses =
      new ArrayList<chalk.tools.coref.mention.Parse>(parses.length);
  ...
  public chalk.tools.coref.mention.Parse getParent() {
    Parse parent = parse.getParent();
    if (parent == null) {
      return null;
    }
  ...
  public int compareTo(chalk.tools.coref.mention.Parse p) {
  ...
  public chalk.tools.coref.mention.Parse getPreviousToken() {
    Parse parent = parse.getParent();
    Parse node = parse;
    int index=-1;
  ...
  public chalk.tools.coref.mention.Parse getNextToken() {
    Parse parent = parse.getParent();
    Parse node = parse;
    int index=-1;
