...
public class ParserModel extends BaseModel {
  ...
  private static class HeadRulesSerializer implements ArtifactSerializer<chalk.tools.parser.lang.en.HeadRules> {

    public chalk.tools.parser.lang.en.HeadRules create(InputStream in) throws IOException,
        InvalidFormatException {
      return new chalk.tools.parser.lang.en.HeadRules(new BufferedReader(new InputStreamReader(in, "UTF-8")));
    }

    public void serialize(chalk.tools.parser.lang.en.HeadRules artifact, OutputStream out)
        throws IOException {
  ...
  public ParserModel(String languageCode, AbstractModel buildModel, AbstractModel checkModel, 
      ...
      ChunkerModel chunkerTagger, chalk.tools.parser.lang.en.HeadRules headRules,
  ...
  public ParserModel(String languageCode, AbstractModel buildModel, AbstractModel checkModel, 
      ...
      chalk.tools.parser.lang.en.HeadRules headRules, ParserType type,
  ...
  public chalk.tools.parser.lang.en.HeadRules getHeadRules() {
    return (chalk.tools.parser.lang.en.HeadRules) 
