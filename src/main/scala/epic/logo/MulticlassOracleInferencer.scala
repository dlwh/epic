...
case class MulticlassOracleInferencer[L, F, W](
  ...
  def oracle(weights : Weights[W], instance : LabeledDatum[L, F]) : (L, FeatureVector[W], Double) = {
    (instance.label,  FeatureVector(labelConjoiner(instance.label, instance.features)), 0.0)
