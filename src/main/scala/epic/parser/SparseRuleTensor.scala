...
final class SparseRuleTensor[L] private(val leftChildOffsets: Array[Int],
                               ...
                               val parentIndicesAndScores: Array[Int]) extends Serializable {
  ...
  def ruleIterator:Iterator[(BinaryRule[Int], Double)] = {
    ...
    } yield BinaryRule(p, lc, rc) -> score
  }
...
//    leftChildOffsets += 0
    ...
    val ret = new SparseRuleTensor[L2](leftChildOffsets.toArray, rightChildIndicesAndOffsets.toArray, parentIndicesAndScores.toArray)
