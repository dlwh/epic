...
class SegmentationModelFactory[L](val startSymbol: L,
  ...
  def makeModel(train: IndexedSeq[Segmentation[L, String]]): SemiCRFModel[L, String] = {
    ...
    val indexed = new IndexedStandardFeaturizer[L](f, startSymbol, lexicon, labelIndex, maxLengthArray, allowedSpanClassifier)
...
object SegmentationModelFactory {
  ...
  @SerialVersionUID(1L)
  class IndexedStandardFeaturizer[L](f: IndexedSurfaceFeaturizer[String],
                                     val startSymbol: L,
