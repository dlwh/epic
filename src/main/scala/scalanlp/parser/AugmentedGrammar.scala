...
/**
 * An AugmentedGrammar is the pairing of a [[scalanlp.parser.RefinedGrammar]]
 * and a [[scalanlp.parser.CoreGrammar]]. It's the main entity in the EPIC
 * parser. Mostly it is a factory for creating
 * [[scalanlp.parser.AugmentedAnchoring]], which are used to create parsers.
 * @author dlwh
 * */
@SerialVersionUID(1L)
...
object AugmentedGrammar {
  /**
   * Creates an AugmentedGrammar from a [[scalanlp.parser.CoreGrammar]]
   * and an identity [[scalanlp.parser.RefinedGrammar]]
   */
  ...
  /**
   * Creates an AugmentedGrammar from a [[scalanlp.parser.RefinedGrammar]]
   * and an identity [[scalanlp.parser.CoreGrammar]]
   */
...
final case class AugmentedAnchoring[L, W](refined: RefinedAnchoring[L, W], core: CoreAnchoring[L, W]) {
  ...
  /**
   * Scores the [[scalanlp.trees.BinaryRule]] with its refinement in this context.
   * Indices are with respect to the [[scalanlp.parser.BaseGrammar]] and refined's refinements
   * @param begin
   * @param split
   * @param end
  ...
  /**
   * Scores the [[scalanlp.trees.UnaryRule]] with its refinement in this context.
   * Indices are with respect to the [[scalanlp.parser.BaseGrammar]] and refined's refinements
   * @param begin
   * @param end
   * @param rule the index of the rule
