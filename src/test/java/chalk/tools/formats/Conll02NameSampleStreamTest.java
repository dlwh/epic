...
import chalk.tools.formats.Conll02NameSampleStream.LANGUAGE;
...
public class Conll02NameSampleStreamTest {
  ...
  private static ObjectStream<NameSample> openData(LANGUAGE lang, String name) throws IOException {
    InputStream in = Conll02NameSampleStreamTest.class.getResourceAsStream("/chalk/tools/formats/" + name);
