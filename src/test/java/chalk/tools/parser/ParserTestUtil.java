...
public class ParserTestUtil {
   ...
   public static HeadRules createTestHeadRules() throws IOException {
     InputStream headRulesIn = 
       ParserTestUtil.class.getResourceAsStream("/chalk/tools/parser/en_head_rules");
       ...
       public void reset() throws IOException {
         try {
          ...
          samples = new ParseSampleStream(new PlainTextByLineStream(
               ...
               ParserTestUtil.class.getResourceAsStream("/chalk/tools/parser/parser.train"), "UTF-8")));
