...
import chalk.tools.postag.DummyPOSTaggerFactory.DummyPOSContextGenerator;
import chalk.tools.postag.DummyPOSTaggerFactory.DummyPOSDictionary;
import chalk.tools.postag.DummyPOSTaggerFactory.DummyPOSSequenceValidator;
...
public class POSTaggerFactoryTest {
  ...
  private static ObjectStream<POSSample> createSampleStream()
    ...
    InputStream in = POSTaggerFactoryTest.class.getClassLoader()
        .getResourceAsStream("chalk/tools/postag/AnnotatedSentences.txt");
