...
import chalk.tools.sentdetect.DummySentenceDetectorFactory.DummyDictionary;
import chalk.tools.sentdetect.DummySentenceDetectorFactory.DummyEOSScanner;
import chalk.tools.sentdetect.DummySentenceDetectorFactory.DummySDContextGenerator;
...
public class SentenceDetectorFactoryTest {
  ...
  private static ObjectStream<SentenceSample> createSampleStream()
    ...
    InputStream in = SentenceDetectorFactoryTest.class.getClassLoader()
        .getResourceAsStream("chalk/tools/sentdetect/Sentences.txt");
  ...
  static Dictionary loadAbbDictionary() throws IOException {
    InputStream in = SentenceDetectorFactoryTest.class.getClassLoader()
        .getResourceAsStream("chalk/tools/sentdetect/abb.xml");
