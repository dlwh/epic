...
import chalk.tools.tokenize.DetokenizationDictionary.Operation;
import chalk.tools.tokenize.Detokenizer.DetokenizationOperation;
...
public class DictionaryDetokenizerTest{
  ...
  static Detokenizer createLatinDetokenizer() throws IOException {
    ...
    "/chalk/tools/tokenize/latin-detokenizer.xml");
