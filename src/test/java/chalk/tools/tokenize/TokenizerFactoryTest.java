...
import chalk.tools.tokenize.DummyTokenizerFactory.DummyContextGenerator;
import chalk.tools.tokenize.DummyTokenizerFactory.DummyDictionary;
...
public class TokenizerFactoryTest {
  ...
  private static ObjectStream<TokenSample> createSampleStream()
    ...
    InputStream in = TokenizerFactoryTest.class.getClassLoader()
        .getResourceAsStream("chalk/tools/tokenize/token.train");
